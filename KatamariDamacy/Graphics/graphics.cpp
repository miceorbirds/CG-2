...
bool Graphics::InitializeScene()
{
	try
	{
		...
		if (!m_model.Initialize("../Data/Objects/nanosuit/nanosuit.obj", this->m_device.Get(), this->m_device_context.Get(), this->m_grass_texture.Get(), this->m_cb_vs_vertexshader))
			return false;
